...
Search for a matching taxon on __PlantNET__ and, if found, return a named list containing useful information extracted from the returned web page. No resolvable name returns "No_data" list elements.
